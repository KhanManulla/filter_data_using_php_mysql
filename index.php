...
<body>
    <b>
        <p align="left" style="margin:5px;">Site Visitor <?php $content = file_get_contents('visitors.txt');
                                                            echo $content; ?></p>
    </b>
        ...
        <div class="main-container">
            ...
            ?>
                ...
                <?php
                    ...
                    echo "<h1 align='center'> Please Select atleast one option Category Or life expectancy</h1>";
                }
            } else {
                ?>
                <?php
